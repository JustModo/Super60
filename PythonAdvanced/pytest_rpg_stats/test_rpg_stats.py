import pytest
from rpg_stats import Character, generate_strength, is_stat_valid
...
#     assert is_stat_valid(5) is True


# def test_valid_stat_lower_bound():
#     assert is_stat_valid(1) is True


# def test_valid_stat_upper_bound():
#     assert is_stat_valid(10) is True


# def test_invalid_stat_too_low():
#     assert is_stat_valid(0) is False


# def test_invalid_stat_too_high():
#     assert is_stat_valid(11) is False
